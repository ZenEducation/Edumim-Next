...
import footerLogo from "../public/assets/images/logo/footer-logo.svg";
// import "../public/assets/css/custom.css";
// import "../public/assets/css/rt-plugins.css";
// import "../public/assets/css/thanksPage.css";
        ...
        <div className="grid grid-cols-1 gap-7 md:grid-cols-2 lg:grid-cols-3">
          <div className="single-footer">
            <div className="lg:max-w-[270px]">
              ...
              <p className="mb-8 text-.8xl font-bold text-white">
            ...
            <div className="flex space-x-[80px]">
              <div className="flex-1 lg:flex-none">
                ...
                <ul className="list-item space-y-5">
                  <li>
                    <a href="#" className="mb-8 text-.8xl font-bold text-white">
                      Home
                    </a>
                  </li>
                  <li>
          ...
          <div className="single-footer">
            ...
            <div className="mb-8 text-.8xl font-bold text-white">
