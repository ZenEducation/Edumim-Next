...
import lightImg from "../public/assets/images/svg/light.svg";
import aboutOne from "../public/assets/images/all-img/about1.png";
import targetImg from "../public/assets/images/svg/target.svg";
const About = () => {
  return (
    <div className="about-area section-padding">
      <div className="container">
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-10">
          <div>
            <Image src={aboutOne} alt="aboutOne" className=" mx-auto" />
          </div>
          <div>
