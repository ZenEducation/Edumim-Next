...
import ok from "../public/assets/images/svg/ok.svg";
import aboutTwo from "../public/assets/images/all-img/about2.png";
      ...
      <div className="container">
        <div className="lg:grid grid-cols-12 gap-[30px]">
          ...
          <div className="xl:col-span-7 lg:col-span-6 col-span-12 lg:pt-0 md:pt-10 pt-6">
            <Image src={aboutTwo} alt="" className=" mx-auto block w-full" />
          </div>
        </div>
      </div>
    </div>
